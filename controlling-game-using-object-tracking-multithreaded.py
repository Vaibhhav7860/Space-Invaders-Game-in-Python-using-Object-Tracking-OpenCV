...
while True:
    ...
    if direction == 'East':
        if last_pressed == ''  or last_pressed == 'left' or last_pressed == 'space' or last_pressed == 'a':
    ...
    #If deteced direction is West, press Left button
        ...
        if last_pressed == '' or last_pressed == 'right' or  last_pressed == 'space' or last_pressed == 'a':
    ...
    cv2.moveWindow("Game Control Window",1000,150)
